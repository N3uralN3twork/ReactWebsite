...
import myLogo from "../../Assets/Images/Quinn_Recent Picture.jpeg";
            ...
            <Container>
                <Row>
                    <Col md={8} className="home-about-description">
                        <h1>
                            <span className="orange"> <Tilt>WELCOME TO MY HOMEPAGE!</Tilt></span>
                        </h1>
                    ...
                    <Col md={4} className="myAvtar">
                        <Tilt>
                            <img src={myLogo} className="img-fluid" alt="avatar" width={1000} />
                        </Tilt>
                    </Col>
                </Row>
            </Container>
